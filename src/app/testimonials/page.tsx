...
const page = () => {
  ...
  const testimonial_data= [
    {
      "testimonial_text": `Clara is: low key, so efficient, so knowledgeable and so incredibly respected in her industry that EVERY OTHER VENDOR LOVES WORKING WITH HER. Which means they’ll all love and do a great job working on your wedding, too.
      I found Clara b/c we had settled on Darlington House as a venue, so I called them to ask for their favorite planners / recommendations, and Clara’s name was one of the few they gave me. I ended up interviewing 3 wedding planners in San Diego, and loved them all and (before I met them) wondered how I would know which to choose. One of my best friends (who is also a wedding planner) told me, when I asked her the best way to pick a planner, she said: “You have to go with your gut. 
      Who is the person you want handling &$#^ when it goes wrong that day? Because something always will.
      Who is the person you feel the most comfortable with and who has your back?” - and I met with great 3 planners, and Clara was the resounding YES for me. There was no contest, even though I really did LOVE the other girls I met with. Clara for sure flies under the radar - so you can’t gage her talent or how amazing she’ll be for your wedding by her Insta page (which is beautiful but not updated like, 19x a day) because we all know that the Insta-facade is a sham.
